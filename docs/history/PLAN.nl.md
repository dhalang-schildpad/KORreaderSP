> Historical planning notes in Dutch (September 2026). Kept for the research and the reasoning behind early decisions. Paths, file names and the puzzle format described here are outdated; see the English docs one level up.
